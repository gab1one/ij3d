...
public class UniverseSettings {
	...
	public static void load() {
		...
		// startupWidth = integer(properties.getProperty("Startup_Width",
		// str(startupWidth)));
		// startupHeight = integer(properties.getProperty("Startup_Height",
		// str(startupHeight)));
		// projection = integer(properties.getProperty("Projection",
		// str(projection)));
		// showGlobalCoordinateSystem =
		// bool(properties.getProperty("Show_Global_Coordinate_System",
		// str(showGlobalCoordinateSystem)));
		// showLocalCoordinateSystemsByDefault =
		// bool(properties.getProperty("Show_Local_Coordinate_System_When_Adding_Content",
		// str(showLocalCoordinateSystemsByDefault)));
		// showScalebar = bool(properties.getProperty("Show_Scalebar",
		// str(showScalebar)));
		// defaultBackground = col(properties.getProperty("Background",
	...
	public static void initFromDialog(Image3DUniverse univ) {
		GenericDialog gd = new GenericDialog("View Preferences",
				univ.getWindow());
		...
		gd.addCheckbox("Show global coordinate system",
				showGlobalCoordinateSystem);
...
//		showLocalCoordinateSystemsByDefault = gd.getNextBoolean();
	...
	public static void apply(Image3DUniverse univ) {
		...
		univ.showAttribute(Image3DUniverse.ATTRIBUTE_COORD_SYSTEM,
				showGlobalCoordinateSystem);
