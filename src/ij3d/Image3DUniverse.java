...
public class Image3DUniverse extends DefaultAnimatableUniverse {
	 ...
	 */
	private Hashtable<String, Content> contents = new Hashtable<String, Content>();
	 ...
	 */
	private ArrayList<TimelapseListener> timeListeners = new ArrayList<TimelapseListener>();
...
//		});
		...
		for (int i = 0; i < num; i++) {
			...
			if (item instanceof Menu) {
				...
				((JCheckBoxMenuItem) jitem).setState(((CheckboxMenuItem) item)
						.getState());
				for (ItemListener l : ((CheckboxMenuItem) item)
						.getItemListeners())
	 ...
	 * @param color
	 *            the color in which the Content is displayed
	 * @param name
	 *            a name for the Content to be added
	 * @param thresh
	 *            a threshold
	 * @param channels
	 *            the color channels to display.
	 * @param resf
	 *            a resampling factor.
	 * @param type
	...
	public Content addContent(ImagePlus image, Color3f color, String name,
		...
		Content c = ContentCreator.createContent(name, image, type, resf, 0,
	 ...
	 * type is one of the constants defined in Content, e.g. VOLUME, SURFACE
	 * etc. For meaning about color, threshold, channels, ... see the
	 * documentation for Content. Default parameters are used for its
	 * attributes:
	 * <ul>
	 * <li>color: null
	 ...
	 *            the image to display
	 * @param color
	 *            the color in which this volume rendering is displayed.
	 * @param name
	 *            the name of the displayed Content.
	 * @param threshold
	 *            the threshold used for the displayed volume rendering
	 * @param channels
	 ...
	 *            the image to display
	 * @param color
	 *            the color in which these orthoslices are displayed.
	 * @param name
	 *            the name of the displayed Content.
	 * @param threshold
	 *            the threshold used for the displayed orthoslices
	 * @param channels
	 *            the displayed color channels, must be a boolean array of
	 *            length 3
	 * @param resamplingF
	 ...
	 *            the image to display
	 * @param color
	 *            the color in which this surface plot is displayed.
	 * @param name
	 *            the name of the displayed Content.
	 * @param threshold
	 *            the threshold used for the displayed surface plot
	 * @param channels
	 *            the displayed color channels, must be a boolean array of
	 *            length 3
	 * @param resamplingF
	 ...
	 *            the image to display
	 * @param color
	 *            the color in which this surface is displayed.
	 * @param name
	 *            the name of the displayed Content.
	 * @param threshold
	 *            the threshold used for generating the surface
	 * @param channels
	 *            the displayed color channels, must be a boolean array of
	 *            length 3
	 * @param resamplingF
	 ...
	 * @param name
	 *            the name for the added Content
	 ...
	 * false. <code>mesh</code> is a list of points which are connected
	 * pairwise, i.e. the 1st point is connected to the 2nd, the 3rd to the 4th,
	 * and so on.</li>
	 ...
	 *            a list of points which make up the mesh.
	 * @param color
	 *            the color in which the points is displayed
	 * @param name
	 *            a name for the added Content
	 * @return the connected Content.
	 */
	 ...
	 */
	public Content addIcospheres(final List<Point3f> points,
			final Color3f color, final int subdivisions, final float radius,
			final String name) {
		final List<Point3f> ico = MeshMaker.createIcosahedron(subdivisions,
				radius);
	 ...
	 * @return the connected Content.
	 */
	public Content addTriangleMesh(List<Point3f> mesh, Color3f color,
			String name) {
	 ...
	 *            triangle.
	 * @param colors
	 *            a List of the colors at each vertex in the mesh
	 * @param name
	 *            a name for the added Content
	 * @return the connected Content.
	 */
	public Content addTriangleMesh(List<Point3f> mesh, List<Color3f> colors,
			String name) {
	...
	/**
	 * @deprecated This method will not be supported in the future. The
	 *             specified 'scale' will be ignored, and the applied scale will
	 *             be calculated automatically from the minimum and maximum
	 *             coordinates of the specified mesh. Use addTriangleMesh
	 *             instead.
	 */
	@Deprecated
	public Content addMesh(List mesh, Color3f color, String name, float scale,
			int threshold) {
